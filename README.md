...
[![GoDoc](https://godoc.org/github.com/Sagleft/goml?status.svg)](https://godoc.org/github.com/Sagleft/goml)
...
```bash
go get github.com/Sagleft/goml/base
...
go get github.com/Sagleft/goml/perceptron
```
